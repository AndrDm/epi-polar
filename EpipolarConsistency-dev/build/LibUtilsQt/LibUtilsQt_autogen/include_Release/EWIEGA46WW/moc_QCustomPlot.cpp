...
#include "../../../../../code/LibUtilsQt/QCustomPlot.h"
...
template <> constexpr inline auto QCP::qt_create_metaobjectdata<qt_meta_tag_ZN3QCPE_t>()
{
    ...
    QtMocHelpers::UintData qt_enums {
        // enum 'ResolutionUnit'
        QtMocHelpers::EnumData<enum ResolutionUnit>(1, 1, QMC::EnumFlags{}).add({
            {    2, ResolutionUnit::ruDotsPerMeter },
            {    3, ResolutionUnit::ruDotsPerCentimeter },
            {    4, ResolutionUnit::ruDotsPerInch },
        }),
        // enum 'ExportPen'
        QtMocHelpers::EnumData<enum ExportPen>(5, 5, QMC::EnumFlags{}).add({
            {    6, ExportPen::epNoCosmetic },
            {    7, ExportPen::epAllowCosmetic },
        }),
        // enum 'SignDomain'
        QtMocHelpers::EnumData<enum SignDomain>(8, 8, QMC::EnumFlags{}).add({
            {    9, SignDomain::sdNegative },
            {   10, SignDomain::sdBoth },
            {   11, SignDomain::sdPositive },
        }),
        // enum 'MarginSide'
        QtMocHelpers::EnumData<enum MarginSide>(12, 12, QMC::EnumFlags{}).add({
        ...
        QtMocHelpers::EnumData<enum AntialiasedElement>(20, 20, QMC::EnumFlags{}).add({
        ...
        // enum 'PlottingHint'
        QtMocHelpers::EnumData<enum PlottingHint>(35, 35, QMC::EnumFlags{}).add({
        ...
        // enum 'Interaction'
        QtMocHelpers::EnumData<enum Interaction>(41, 41, QMC::EnumFlags{}).add({
            {   42, Interaction::iRangeDrag },
            {   43, Interaction::iRangeZoom },
            {   44, Interaction::iMultiSelect },
            {   45, Interaction::iSelectPlottables },
            {   46, Interaction::iSelectAxes },
            {   47, Interaction::iSelectLegend },
            {   48, Interaction::iSelectItems },
            {   49, Interaction::iSelectOther },
        }),
        // flag 'Interactions'
        QtMocHelpers::EnumData<Interactions>(50, 41, QMC::EnumIsFlag).add({
            {   42, Interaction::iRangeDrag },
            {   43, Interaction::iRangeZoom },
            {   44, Interaction::iMultiSelect },
            {   45, Interaction::iSelectPlottables },
        ...
        QtMocHelpers::EnumData<enum SelectionRectMode>(51, 51, QMC::EnumFlags{}).add({
            {   52, SelectionRectMode::srmNone },
            {   53, SelectionRectMode::srmZoom },
            {   54, SelectionRectMode::srmSelect },
            {   55, SelectionRectMode::srmCustom },
        }),
        // enum 'SelectionType'
        QtMocHelpers::EnumData<enum SelectionType>(56, 56, QMC::EnumFlags{}).add({
            {   57, SelectionType::stNone },
            {   58, SelectionType::stWhole },
            {   59, SelectionType::stSingleData },
            {   60, SelectionType::stDataRange },
            {   61, SelectionType::stMultipleDataRanges },
        }),
    };
    return QtMocHelpers::metaObjectData<QCP, qt_meta_tag_ZN3QCPE_t>(QMC::PropertyAccessInStaticMetaCall, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject QCP::staticMetaObject = { {
    nullptr,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN3QCPE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN3QCPE_t>.data,
    nullptr,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN3QCPE_t>.metaTypes,
    nullptr
} };
...
template <> constexpr inline auto QCustomPlot::qt_create_metaobjectdata<qt_meta_tag_ZN11QCustomPlotE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Slot 'replot'
        QtMocHelpers::SlotData<void(QCustomPlot::RefreshPriority)>(36, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 37, 38 },
        }}),
        // Slot 'replot'
        QtMocHelpers::SlotData<void()>(36, 2, QMC::AccessPublic | QMC::MethodCloned, QMetaType::Void),
        // Slot 'processRectSelection'
        QtMocHelpers::SlotData<void(QRect, QMouseEvent *)>(39, 2, QMC::AccessProtected, QMetaType::Void, {{
            { 0x80000000 | 40, 41 }, { 0x80000000 | 3, 4 },
        }}),
    ...
    QtMocHelpers::UintData qt_properties {
        // property 'viewport'
        QtMocHelpers::PropertyData<QRect>(44, 0x80000000 | 40, QMC::DefaultPropertyFlags | QMC::Writable | QMC::EnumOrFlag | QMC::StdCppSet),
        // property 'background'
        QtMocHelpers::PropertyData<QPixmap>(45, 0x80000000 | 46, QMC::DefaultPropertyFlags | QMC::Writable | QMC::EnumOrFlag | QMC::StdCppSet),
        ...
        QtMocHelpers::PropertyData<Qt::AspectRatioMode>(48, 0x80000000 | 49, QMC::DefaultPropertyFlags | QMC::Writable | QMC::EnumOrFlag | QMC::StdCppSet),
        // property 'plotLayout'
        QtMocHelpers::PropertyData<QCPLayoutGrid*>(50, 0x80000000 | 51, QMC::DefaultPropertyFlags | QMC::EnumOrFlag),
        ...
        QtMocHelpers::PropertyData<Qt::KeyboardModifier>(55, 0x80000000 | 56, QMC::DefaultPropertyFlags | QMC::Writable | QMC::EnumOrFlag | QMC::StdCppSet),
        // property 'openGl'
        QtMocHelpers::PropertyData<bool>(57, QMetaType::Bool, QMC::DefaultPropertyFlags | QMC::Writable | QMC::StdCppSet),
    };
    QtMocHelpers::UintData qt_enums {
        // enum 'LayerInsertMode'
        QtMocHelpers::EnumData<enum LayerInsertMode>(58, 58, QMC::EnumFlags{}).add({
            {   59, LayerInsertMode::limBelow },
            {   60, LayerInsertMode::limAbove },
        }),
        // enum 'RefreshPriority'
        QtMocHelpers::EnumData<enum RefreshPriority>(61, 61, QMC::EnumFlags{}).add({
            {   62, RefreshPriority::rpImmediateRefresh },
            {   63, RefreshPriority::rpQueuedRefresh },
            {   64, RefreshPriority::rpRefreshHint },
            {   65, RefreshPriority::rpQueuedReplot },
        }),
    };
...
void QCustomPlot::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 16: _t->rescaleAxes((*reinterpret_cast<std::add_pointer_t<bool>>(_a[1]))); break;
        case 17: _t->rescaleAxes(); break;
        case 18: _t->deselectAll(); break;
        case 19: _t->replot((*reinterpret_cast<std::add_pointer_t<QCustomPlot::RefreshPriority>>(_a[1]))); break;
        case 20: _t->replot(); break;
        case 21: _t->processRectSelection((*reinterpret_cast<std::add_pointer_t<QRect>>(_a[1])),(*reinterpret_cast<std::add_pointer_t<QMouseEvent*>>(_a[2]))); break;
        case 22: _t->processRectZoom((*reinterpret_cast<std::add_pointer_t<QRect>>(_a[1])),(*reinterpret_cast<std::add_pointer_t<QMouseEvent*>>(_a[2]))); break;
        case 23: _t->processPointSelection((*reinterpret_cast<std::add_pointer_t<QMouseEvent*>>(_a[1]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::RegisterMethodArgumentMetaType) {
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        if (QtMocHelpers::indexOfMethod<void (QCustomPlot::*)()>(_a, &QCustomPlot::beforeReplot, 14))
            return;
        if (QtMocHelpers::indexOfMethod<void (QCustomPlot::*)()>(_a, &QCustomPlot::afterReplot, 15))
            return;
    }
    if (_c == QMetaObject::RegisterPropertyMetaType) {
        switch (_id) {
...
template <> constexpr inline auto QCPColorGradient::qt_create_metaobjectdata<qt_meta_tag_ZN16QCPColorGradientE_t>()
{
    ...
    QtMocHelpers::UintData qt_enums {
        ...
        // enum 'GradientPreset'
        QtMocHelpers::EnumData<enum GradientPreset>(4, 4, QMC::EnumFlags{}).add({
            {    5, GradientPreset::gpGrayscale },
            {    6, GradientPreset::gpHot },
            {    7, GradientPreset::gpCold },
            {    8, GradientPreset::gpNight },
            {    9, GradientPreset::gpCandy },
            {   10, GradientPreset::gpGeography },
            {   11, GradientPreset::gpIon },
            {   12, GradientPreset::gpThermal },
            {   13, GradientPreset::gpPolar },
            {   14, GradientPreset::gpSpectrum },
            {   15, GradientPreset::gpJet },
            {   16, GradientPreset::gpHues },
        }),
    };
