...
namespace GetSetGui
{
	...
	void GetSetTabWidget::addDefaultFileMenu()
	{
		...
		m_menus["File"]->addAction(tr("&About"), this, &GetSetTabWidget::about);

		auto* scripting_menu = m_menus["File"]->addMenu(tr("Scripting"));

		m_menus["File"]->addSeparator();

		m_menus["File"]->addAction(
			tr("&Quit"),
		...
		// Scripting menu
		scripting_menu->addAction(tr("(Re-)Start Recording"), this, &GetSetTabWidget::rec_start);
		scripting_menu->addAction(tr("Stop Recording"), this, &GetSetTabWidget::rec_stop);

		scripting_menu->addSeparator();

		scripting_menu->addAction(
			tr("Run default script."),
			this,
			&GetSetTabWidget::script_run_default,
			QKeySequence(Qt::CTRL | Qt::SHIFT | Qt::Key_D)
		);

		scripting_menu->addAction(
			tr("Show Script &Editor..."),
			this,
			&GetSetTabWidget::script_editor,
